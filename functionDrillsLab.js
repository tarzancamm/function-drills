...
let nameGreeting = nameCheck('Bob')
...
let bestMovie = string => `${string} is the best movie ever!`;

console.log(bestMovie('Let There Be Blood'))
...
let theEliminator = (arr1, theLoser) => {
...
console.log(emailCheck('  cameronsminer@gmail.com'))
